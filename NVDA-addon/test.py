...
print( "type of RegisterClipboardFormat: %s" % str(windll.user32.RegisterClipboardFormatA))
...
print("MathCAT registering data formats: CF_MathML %x, CF_MathML_Presentation %x" %
